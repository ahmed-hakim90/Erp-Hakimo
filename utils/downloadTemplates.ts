...
export function downloadProductsTemplate() {
  ...
  const aoa: (string | number)[][] = [
    ...
    ['خلاط سوكانى 6000 وات', 'SK-999N', 'المنتجات النهائية', 100, 45.5, 2.5, 18, 6, 150],
    ['صمام V-200', 'PRD-002', 'المنتجات النهائية', 250, 30, 1.8, 12, 12, 85],
    ['لوح معدني خام', 'PRD-003', 'المواد الخام', 500, 0, 0, 0, 0, 0],
    ['محور دوران', 'PRD-004', 'نصف مصنع', 80, 15, 1, 10, 8, 60],
    ['مسمار 10مم', 'PRD-005', 'المواد الخام', 2000, 0, 0, 0, 0, 0],
  ];
