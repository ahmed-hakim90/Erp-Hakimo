              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-black text-slate-700 dark:text-slate-200 truncate">{widget.label}</p>
                    <p className="text-xs text-slate-400 truncate">{widget.description || widget.target || 'رابط سريع'}</p>
                  </div>
                </div>
            ...
            <Card key={widget.id}>
              <div className="flex items-start justify-between gap-3">
                <div className="space-y-1">
                  <p className="text-sm font-black text-slate-700 dark:text-slate-200">{widget.label}</p>
                  <p className="text-2xl font-black text-primary">
                    {widget.value || '—'}
                    {widget.unit ? <span className="text-sm font-bold text-slate-400 mr-1">{widget.unit}</span> : null}
                  </p>
                  {widget.description && (
